<template>
  <div class="container-fluid">
    ...
    <div>
    <!-- Add Student Button that opens the dialog -->
    <button class="btn btn-primary" @click="showAddStudentDialog = true">
      Add Student
    </button>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form @submit.prevent="addStudent">
              ...
              <!-- Search Button -->
              <button class="btn btn-primary btn-sm" type="button" @click="searchStudents">
              ...
              <div class="mb-3 button-right">
                <button class="btn btn-success btn-sm" type="submit" :disabled="!selectedStudent">
                  <span class="material-symbols-outlined">add</span> Add Student
                </button>
              </div>
...
export default {
    ...
    async addStudent() {
      ...
      try {
        ...
        const response = await axios.post(
          'http://localhost/CheckEaseNew-Master/vue-login-backend/addStudent.php',
          newStudent,
          {
  ...
  try {
    const response = await axios.get('http://localhost/CheckEaseNew-Master/vue-login-backend/searchStudent.php', {
  ...
  try {
    ...
    const response = await axios.get('http://localhost/CheckEaseNew-Master/vue-login-backend/fetchStudents.php', {
      headers: {
